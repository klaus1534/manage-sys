...
<div class="container-fluid">
    <h1 class="page-header">市级资料维护</h1>
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="post" id="editEntityForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="parentId" class="col-sm-2 control-label">省份:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="cityName" class="col-sm-2 control-label">市级名:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="cityName" name="cityName" placeholder="输入市级名">
                        </div>
                    </div>
                </div>
                <%--modal dialog body Start--%>
...
<script type="application/javascript">
    $('#createModal').on('show.bs.modal', function (event) {
        ...
        if (extraData == null && extraData == undefined) {
            modal.find('.modal-title').html('添加市级');
            modal.find('input').val('');
            modal.find('#editEntityForm').attr('action', 'create');
        } else {
            modal.find('.modal-title').html('编辑市级');
